...
def _load_report_config(config_data: Dict) -> Dict:
    ...
    max_total_news_env = _get_env_int("MAX_TOTAL_NEWS")
    ...
    return {
        ...
        "MAX_TOTAL_NEWS": max_total_news_env or report_config.get("max_total_news", 0),
    }
...
def _load_watch_config(config_path: str) -> Dict:
    ...
    return {
        ...
        "USER_AGENT": fetch.get("user_agent", "GEINEWS Watch/1.0"),
