...
def send_to_wework(
    ...
    *,
    ...
    effective_batch_size = min(batch_size, 2048) if is_text_mode else min(batch_size, 4096)
    ...
    batches = split_content_func(
        report_data, "wework", update_info, max_bytes=effective_batch_size - header_reserve, mode=mode,
        rss_items=rss_items,
        rss_new_items=rss_new_items,
        ai_content=ai_content,
        standalone_data=standalone_data,
